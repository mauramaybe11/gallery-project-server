...
// CREATE
// POST /examples
router.post('/artPieces', requireToken, (req, res, next) => {
  // set owner of new example to be current user
  // this may be req.body.owner = req.user.id
  req.body.art.owner = req.user.id
...
router.patch('/artPieces/:id', requireToken, removeBlanks, (req, res, next) => {
  // if the client attempts to change the `owner` property by including a new
  // owner, prevent that by deleting that key/value pair
  delete req.body.art.owner
  ...
  Art.findById(req.params.id)
    ...
    .then(art => {
      ...
      return art.updateOne(req.body.art)
    })
